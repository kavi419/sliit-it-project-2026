...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    /**
     * Conflict Check: Find any APPROVED or PENDING bookings for the same resource that overlap
    ...
    @org.springframework.data.jpa.repository.Query("SELECT b FROM Booking b WHERE b.resourceName = :resourceName " +
            "AND b.status IN ('PENDING', 'APPROVED') AND b.id <> :excludeId AND b.startTime < :endTime AND b.endTime > :startTime")
