...
import com.springboot.smartcampus.model.ResourceEntity;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        com.springboot.smartcampus.model.UserEntity systemUser = userRepository.findByEmail("system@smartcampus.com")
                .orElseGet(() -> {
                    com.springboot.smartcampus.model.UserEntity u = com.springboot.smartcampus.model.UserEntity.builder()
        ...
        if (userRepository.findByEmail("pending.admin@test.com").isEmpty()) {
            userRepository.save(com.springboot.smartcampus.model.UserEntity.builder()
        ...
        if (bookingRepository.count() == 0) {
            ...
            bookingRepository.save(com.springboot.smartcampus.model.BookingEntity.builder()
                    .user(systemUser)
        ...
        if (ticketRepository.count() == 0) {
            ticketRepository.save(com.springboot.smartcampus.model.TicketEntity.builder()
